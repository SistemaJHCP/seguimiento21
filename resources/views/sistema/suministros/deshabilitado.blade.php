...
@section('titulo')
    <h1 class="m-0"> Suministros  <small>deshabilitados</small></h1>
@endsection
@section('navegador')
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <!-- /.card-header -->
                  <div class="card-body">
                      <table id="listaSuministrosDes" class="table table-bordered table-hover display responsive no-wrap">
                      <thead>
                      <tr>
                          <th>Codigo</th>
                  ...
                  <metadata>
                    <rdf:RDF>
                      <cc:Work>
                        ...
                        <dc:title>Architetto -- ruota dentata grigia</dc:title>
                        <dc:date>2010-03-25T20:41:45</dc:date>
                        <dc:description>Drawing by Francesco 'Architetto' Rollandin. From OCAL 0.18 release.</dc:description>
                        <dc:source>http://openclipart.org/detail/34123/architetto----ruota-dentata-grigia-by-anonymous</dc:source>
                        <dc:creator>
                          <cc:Agent>
...
<script src="{{ asset("js/suministros/deshabilitar.js") }}"></script>
@endsection
@section('css')
