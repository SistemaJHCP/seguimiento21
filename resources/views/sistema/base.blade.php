    ...
    <div class="col-md-12">
        <div class="card card-info card-outline">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-9"><h3 class="card-title"><label for="">Seleccione las opciones pertinentes</label></h3></div>
                    <div class="col-md-3">
            ...
            <input type="hidden" name="req2" id="req2" value="{{ $solicitud->requisicion_id }}">
            <input type="hidden" name="dato" id="dato" value="{{ $solicitud->id }}">
            <input type="hidden" name="nroCuenta" id="nroCuenta" value="{{ $solicitud->banco_proveedor_id }}">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        @if ($solicitud->moneda == "$")
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input"  name="dolares" id="tramiteDolar" autocomplete="off" {{$checkMoneda}} disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="proveedor" id="proveedor" class="form-control" required>
                                        ...
                                        @foreach ($proveedor as $p)
                                            <option value="{{ $p->id }}" {!! ($solicitud->proveedor_id === $p->id) ?  "selected" : ""; !!}>{{ $p->proveedor_nombre }}</option>
                                        @endforeach
                                    </select>
                                    <div id="opcion21"></div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="forma_pago" id="forma_pago" class="form-control" required>
                                        <option value="">Seleccione...</option>
                                        <option value="1" {!! ($solicitud->solicitud_formapago === 1) ?  "selected" : ""; !!}>Transferencia</option>
                                        <option value="2" {!! ($solicitud->solicitud_formapago === 2) ?  "selected" : ""; !!}>Depósito</option>
                                        <option value="3" {!! ($solicitud->solicitud_formapago === 3) ?  "selected" : ""; !!}>Cheque</option>
                                        <option value="4" {!! ($solicitud->solicitud_formapago === 4) ?  "selected" : ""; !!}>Efectivo</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="iva" id="iva" class="form-control" required>
                                        <option value="">Seleccione...</option>
                                        <option value="1" {!! ($solicitud->solicitud_iva === 1) ?  "selected" : ""; !!}>No</option>
                                        <option value="2" {!! ($solicitud->solicitud_iva === 2) ?  "selected" : ""; !!}>Si</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card card-info card-outline">
                    ...
                    <div class="card-body">
                        <textarea name="motivo" id="motivo" class="form-control" maxlength="250" required>{{ $solicitud->solicitud_motivo }}</textarea>
                    </div>
                </div>
                ...
                <div class="card card-info card-outline">
                    ...
                    <div class="card-body">
                        <textarea name="observacion" id="observacion" maxlength="250" class="form-control">{{ $solicitud->solicitud_observaciones }}</textarea>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <div class="card card-info card-outline">
                    ...
                    <div class="card-footer">
                        ...
                        <input type="submit" value="Modificar solicitud" class="btn btn-info float-right" id="modificarSolicitud">
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{ asset("js/solicitud/cumana.js") }}"></script>
@if($errors->any())
<h4>{{$errors->first()}}</h4>
@endif
<script>
