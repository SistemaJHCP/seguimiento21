              ...
              <div class="modal-content">
                ...
                <form action="{{ route('banco.guardar') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="rif" id="rif" class="form-control" placeholder="Rif / Ruc" maxlength="20">
                        <label>Ingrese el nombre del banco</label>
                        <input type="text" name="nombreBanco" id="nombreBanco" class="form-control" placeholder="Ingrese el nombre" maxlength="40">
                    </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="{{ route('banco.modificar') }}" method="post">
                    ...
                    <div class="form-group">
                        <label>Ingrese el Rif / Ruc de banco</label>
                        <input type="text" name="rif" id="rifMod" class="form-control" placeholder="Rif / Ruc" maxlength="20" disabled>
                        <label>Ingrese el nombre del banco</label>
                        <input type="text" name="nombreBanco" id="nombreBancoMod" class="form-control" placeholder="Ingrese el nombre" maxlength="40" disabled>
                        <input type="hidden" name="dato" id="dato">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" id="cerrarNuevoMod" data-dismiss="modal">Cerrar</button>
