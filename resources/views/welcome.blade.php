    ...
    <body class="row">
        <div class="container" style="margin-top: 6%;">
            <div class="row">
              ...
              <div class="col-md-7 col-12" class="img img-responsive" style="border: 1px solid black;background-image: url('{{asset('imagen/img-inicial-1.jpg')}}');background-repeat:no-repeat;background-size: 100% 100%;">
